...
const SKILL_DEFINITIONS = {
    ...
    lay_on_hands: {
        id: 'lay_on_hands',
        name: 'Lay on Hands',
        description: 'Holy touch: heal self 15% HP and deal 0.5× WILL holy damage.',
        archetype: Archetype.PALADIN,
        activation: SkillActivation.ACTIVE,
        target: SkillTarget.SINGLE,
        damageType: DamageType.MAGICAL,
        scaling: [{ stat: 'will', percent: 0.5 }],
        baseValue: 0.5,           // 0.5× WILL damage
        selfHealPercent: 0.15,    // Heal 15% max HP
        cooldown: 2,
        icon: '🙏',
    },
...
const SKILL_TREES = {
    ...
    lay_on_hands: {
        early: [
            { id: 'greater_heal', name: 'Greater Heal', type: NodeType.MINOR, cost: 1, effect: '+3% self heal' },
            { id: 'blessed_touch', name: 'Blessed Touch', type: NodeType.MINOR, cost: 1, effect: '+10% holy damage' },
            { id: 'soothing', name: 'Soothing', type: NodeType.MINOR, cost: 1, effect: '+3% self heal' },
            { id: 'radiance', name: 'Radiance', type: NodeType.MINOR, cost: 1, effect: '+10% holy damage' },
            { id: 'holy_fire', name: 'Holy Fire', type: NodeType.MAJOR, cost: 1, effect: 'Burns undead: +50% damage vs undead' },
        ],
        mid: [
            { id: 'divine_favor', name: 'Divine Favor', type: NodeType.MAJOR, cost: 2, effect: '+20% damage and healing' },
            { id: 'overheal', name: 'Overheal', type: NodeType.MAJOR, cost: 1, effect: 'Excess heal = temp HP shield' },
            { id: 'cleanse', name: 'Cleanse', type: NodeType.MAJOR, cost: 2, effect: 'Remove 1 debuff on cast' },
            { id: 'renewal', name: 'Renewal', type: NodeType.MAJOR, cost: 1, effect: '+5% HOT over 2 turns' },
            { id: 'smite', name: 'Smite', type: NodeType.MAJOR, cost: 1, effect: '+0.25× WILL damage' },
        ],
        deep: [
            { id: 'exorcism', name: 'Exorcism', type: NodeType.MAJOR, cost: 2, effect: '2× damage vs undead/demons' },
            { id: 'divine_light', name: 'Divine Light', type: NodeType.MAJOR, cost: 2, effect: 'Heal = 0.3× WILL (replaces %)' },
            { id: 'martyrdom', name: 'Martyrdom', type: NodeType.MAJOR, cost: 1, effect: 'Cost 10% HP, +60% damage' },
            { id: 'beacon', name: 'Beacon', type: NodeType.MAJOR, cost: 1, effect: '+15% damage next 2 turns on hit' },
            { id: 'divine_wrath', name: 'Divine Wrath', type: NodeType.CAPSTONE, cost: 1, effect: '-1 CD, +0.5× WILL dmg, +10% heal' },
        ],
    },
    divine_shield: {
        early: [
